...
echo "Starting Root Dev update process..."
...
LATEST_RELEASE_URL=$(curl -s https://api.github.com/repos/stackblitz-labs/root.dev/releases/latest | grep "browser_download_url.*zip" | cut -d : -f 2,3 | tr -d \")
